...
class Warning_Processor(object):
    ...
    def __init__(self,  warning_dir: str = trans_config_abspath(config_defaluts["exception-monitoring-directory"])):
        # 存储相关信息
    ...
    def show_custom_warning_dialog(self, warning_type: str, warning_time: str, level_description: int):
        ...
        # 加载和显示危险等级图标
        risk_image_path = os.path.join(self.warning_dir, f"warning_png/{warning_type}.png")
